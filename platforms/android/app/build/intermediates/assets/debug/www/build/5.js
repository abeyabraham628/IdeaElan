...
var ApplyLeavePage = /** @class */ (function () {
    ...
    ApplyLeavePage.prototype.leaveHistory = function () {
        this.leaveRecords = this.userLeave.getPastLeaves(this.afauth.auth.currentUser.uid);
    };
