...
devicetoken : any ="abc";
  ...
  constructor(public modalCtrl:ModalController, private fcm:FCM,public navCtrl: NavController, public navParams: NavParams,private afAuth:AngularFireAuth,private firebase:AngularFireDatabase,public loadingCtrl: LoadingController) {
    this.lrcountcheck();
