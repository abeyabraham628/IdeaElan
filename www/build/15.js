...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modifysystems__ = __webpack_require__(849);
...
var ModifysystemsPage = /** @class */ (function () {
    ...
    ModifysystemsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["Component"])({
            selector: 'page-modifysystems',template:/*ion-inline-start:"D:\IdeaElan\src\pages\modifysystems\modifysystems.html"*/'<!--\n\n Tony Manuel\n\n-->\n\n<ion-header>\n\n  <navbar pageTitle="System"></navbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content padding >\n\n    \n\n    \n\n   \n\n\n\n      <ion-item no-lines>\n\n        <h3 style="font-size:20px">Change {{fieldName}}</h3>\n\n        <p style="font-size:12px">Enter the new {{fieldName}} details.</p>\n\n        </ion-item>\n\n\n\n       <ion-item >\n\n        <ion-label stacked></ion-label>\n\n        <ion-input *ngIf="showDefault" type="text"  [(ngModel)]="default" ></ion-input>\n\n        <button *ngIf="showDefault"  ion-button small type="button" (click)="scanBarCode(\'keyboard\')" color="blue" item-right>\n\n          <ion-icon name="barcode"> </ion-icon>\n\n        </button>\n\n        <ion-select *ngIf="showSystemUser" [(ngModel)]="systemUser">\n\n          <ion-option *ngFor="let emp of employeeList" [value]="emp.$key">{{emp.fName}} {{emp.lName}}</ion-option>\n\n        </ion-select>\n\n        <ion-input *ngIf="showavExpiry" type="text" readonly [(ngModel)]="avExpiry" (tap)="dispDate()"></ion-input>\n\n        </ion-item>\n\n        <ion-item no-lines [hidden]="fieldErr">\n\n          <ion-label stacked color="danger">{{fieldName}} value is invalid</ion-label>\n\n        </ion-item>\n\n       \n\n      \n\n      \n\n     <ion-row>\n\n       <ion-item col-6 no-lines>\n\n         <button ion-button color="blue" style="height:40px;" type="button" (click)="updateSystems()">Save Details</button>\n\n       </ion-item>\n\n       \n\n     </ion-row>\n\n    \n\n  \n\n    <hr/>\n\n</ion-content>\n\n'/*ion-inline-end:"D:\IdeaElan\src\pages\modifysystems\modifysystems.html"*/,
        }),
        Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__ionic_native_barcode_scanner__["a" /* BarcodeScanner */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__ionic_native_barcode_scanner__["a" /* BarcodeScanner */]) === "function" ? _a : Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__ionic_native_date_picker__["a" /* DatePicker */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__ionic_native_date_picker__["a" /* DatePicker */]) === "function" ? _b : Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_6__providers_form_service__["a" /* DataService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__providers_form_service__["a" /* DataService */]) === "function" ? _c : Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["NavController"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["NavController"]) === "function" ? _d : Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["NavParams"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["NavParams"]) === "function" ? _e : Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_2__angular_fire_database__["a" /* AngularFireDatabase */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_fire_database__["a" /* AngularFireDatabase */]) === "function" ? _f : Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["AlertController"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["AlertController"]) === "function" ? _g : Object])
    ], ModifysystemsPage);
