...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_employee_model__ = __webpack_require__(805);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic_angular__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__leaves_admin__ = __webpack_require__(850);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__models_leave_model__ = __webpack_require__(772);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__models_datepicker__ = __webpack_require__(762);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_datepicker__ = __webpack_require__(762);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_leave_model__ = __webpack_require__(772);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ionic_angular__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__models_employee_model__ = __webpack_require__(805);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_moment__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_md_date_time_picker_dist_js_mdDateTimePicker_js__ = __webpack_require__(765);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_md_date_time_picker_dist_js_mdDateTimePicker_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_md_date_time_picker_dist_js_mdDateTimePicker_js__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LeavesAdminPage = /** @class */ (function () {
    function LeavesAdminPage(renderer, nativeDatePicker, navCtrl, userLeave, modalCtrl, navParams, empDetails, customDatePicker) {
        ...
        this.leaveRecords = [];
        this.waitForPop = new __WEBPACK_IMPORTED_MODULE_6_rxjs__["BehaviorSubject"](true);
        this.dateLimit = null;
    ...
    LeavesAdminPage.prototype.dispDate = function (type) {
        var _this = this;
        if (type === "from") {
            var datePicker_1 = new __WEBPACK_IMPORTED_MODULE_8_md_date_time_picker_dist_js_mdDateTimePicker_js__["default"]({
                type: 'date',
                trigger: this.dateFromElem.nativeElement
            });
            datePicker_1.toggle();
            this.renderer.listen(this.dateFromElem.nativeElement, 'onOk', function () {
                _this.dateFrom = __WEBPACK_IMPORTED_MODULE_7_moment__(datePicker_1.time).format('D-MMM-YYYY');
                _this.dateLimit = __WEBPACK_IMPORTED_MODULE_7_moment__(datePicker_1.time);
            });
        }
        else if (type == 'to' && this.dateLimit != null) {
            var datePicker_2 = new __WEBPACK_IMPORTED_MODULE_8_md_date_time_picker_dist_js_mdDateTimePicker_js__["default"]({
                type: 'date',
                past: this.dateLimit,
                trigger: this.dateToElem.nativeElement
            });
            datePicker_2.toggle();
            this.renderer.listen(this.dateToElem.nativeElement, 'onOk', function () {
                _this.dateTo = __WEBPACK_IMPORTED_MODULE_7_moment__(datePicker_2.time).format('D-MMM-YYYY');
    ...
    ], LeavesAdminPage.prototype, "dateFromElem", void 0);
    __decorate([
