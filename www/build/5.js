...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__interview_schedule__ = __webpack_require__(848);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_date_picker__ = __webpack_require__(470);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_md_date_time_picker_dist_js_mdDateTimePicker_js__ = __webpack_require__(765);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_md_date_time_picker_dist_js_mdDateTimePicker_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_md_date_time_picker_dist_js_mdDateTimePicker_js__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var InterviewSchedulePage = /** @class */ (function () {
    function InterviewSchedulePage(renderer, alertCtrl, datePicker, navCtrl, navParams, firebase) {
    ...
    InterviewSchedulePage.prototype.dispDate = function (type) {
        var _this = this;
        if (type == "date") {
            var datePicker_1 = new __WEBPACK_IMPORTED_MODULE_6_md_date_time_picker_dist_js_mdDateTimePicker_js__["default"]({
                type: 'date',
                past: __WEBPACK_IMPORTED_MODULE_4_moment__(),
                future: __WEBPACK_IMPORTED_MODULE_4_moment__().add(5, 'months'),
                trigger: this.dateElem.nativeElement
            });
            datePicker_1.toggle();
            this.renderer.listen(this.dateElem.nativeElement, 'onOk', function () {
                _this.scheduleForm.controls.scheduleDate.setValue(__WEBPACK_IMPORTED_MODULE_4_moment__(datePicker_1.time).format('D-MMM-YYYY'));
            });
        }
        else {
            var datePicker_2 = new __WEBPACK_IMPORTED_MODULE_6_md_date_time_picker_dist_js_mdDateTimePicker_js__["default"]({
                type: 'time',
                //past:moment(),
            ...
            datePicker_2.toggle();
            this.renderer.listen(this.dateElem.nativeElement, 'onOk', function () {
                _this.scheduleForm.controls.scheduleTime.setValue(__WEBPACK_IMPORTED_MODULE_4_moment__(datePicker_2.time).format('h:m A'));
            });
        }
    };
    //
