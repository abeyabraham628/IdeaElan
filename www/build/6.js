...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage.prototype.signIn = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var result, navCtrl_1, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, this.afAuth.auth.signInWithEmailAndPassword('tony@gmail.com', '9902771821')];
                    case 1:
                        result = _a.sent();
                        navCtrl_1 = this.navCtrl;
                        if (!result) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.firebase.database.ref('TempLogin').orderByChild(result.user.uid).on("value", function (snapshot) {
                                if (snapshot.val() == null)
                                    navCtrl_1.setRoot('ChangepasswordPage');
                                else
                                    navCtrl_1.setRoot('TabsPage');
                            })];
                    case 2:
                        _a.sent();
                        _a.label = 3;
    ...
    LoginPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_0__angular_fire_auth__["a" /* AngularFireAuth */], __WEBPACK_IMPORTED_MODULE_3__angular_fire_database__["a" /* AngularFireDatabase */]])
    ], LoginPage);
    return LoginPage;
}());
