...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__forgotpassword__ = __webpack_require__(821);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_strings__ = __webpack_require__(750);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_storage__ = __webpack_require__(462);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ForgotpasswordPage = /** @class */ (function () {
    function ForgotpasswordPage(toastCtrl, navCtrl, navParams, afauth, storage) {
        this.toastCtrl = toastCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.afauth = afauth;
        this.storage = storage;
        this.passwordResetForm = new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormGroup"]({
    ...
    ForgotpasswordPage.prototype.resetPassword = function () {
        ...
        auth.sendPasswordResetEmail(emailAddress).then(function () {
            ...
            var errMsg = __WEBPACK_IMPORTED_MODULE_4__providers_strings__["a" /* AppConst */].FirebaseError.find(function (e) { return e.code == error.code; });
            var toast = _this.toastCtrl.create({
